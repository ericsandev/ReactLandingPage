...
export const list_top_creator = [
	{
		id: 1,
		username: 'Eric Sanchez',
		price: 1.646567,
		image: '/creators/pfp_4.png',
		bgimage: '/creators/pfp_4.png',
		product_name: 'TI',
		url: 'https://twitter.com/ericsandev',
		description: 'Developer',
		button: '@ericsandev',
	},
	{
		id: 2,
		username: 'WeirdAmigos',
		price: 2.34111,
		image: '/creators/pfp_5.png',
		bgimage: '/creators/pfp_5.png',
		product_name: 'CEO',
		description: 'WeirdAmigos',
		button: '@weirdAmigos',
...
export const list_FAQ = [
	...
	{
		id: 2,
		title: 'Wich wallets will be able to use?',
		desc: 'The  runs on Solana blockchain, so you will need a solana wallet for minting, Phantom is the recommended wallet.',
	},
	{
		id: 3,
	...
	},
	{
		...
		desc: 'We are keeping 10% of Kraneoz for the 3 founders.',
	},
	{
		id: 5,
...
export const hypnoData = [
	{
		hero: {
			title: 'Kraneoz',
			resume: '6,666 demons called Kraneoz, soldiers from hell who are going to conquer the Solana blockchain.',
		},
	},
];
